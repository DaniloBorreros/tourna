<?php
    ...
    $query = "SELECT s.team1, s.team2, s.schedule, s.place, s.sport, s.winner, t1.name AS team1_name, t1.logo AS team1_logo, t2.name AS team2_name, t2.logo AS team2_logo, sp.name AS sport_name
              FROM schedule s 
              LEFT JOIN team t1 ON s.team1 = t1.id 
              LEFT JOIN team t2 ON s.team2 = t2.id
              LEFT JOIN sport sp ON s.sport = sp.id
              WHERE s.winner IS NOT NULL OR s.loser IS NOT NULL
...
<div class="container text-center">
    <h3>Tournament Match-up Results</h3>
    <div class="row text-center">
        ...
        <?php
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while($row = mysqli_fetch_assoc($result)) {
                    // Determine the values of $result1 and $result2 based on the conditions
                                ...
                                <div class="row plays-team">
                                    <div class="col-md-5">
                                        <a href="roster.php?sport=<?php echo $row['sport']; ?>&team=<?php echo urlencode($row['team1_name']); ?>">
                                            ...
                                            <span style="font-weight: bold; text-decoration: none; color: black">
                                            <?php echo $row['team1_name']; ?> 
                                                <span style="color: <?php $color1; ?>;">(<?php echo $result1; ?>)</span>
                                            </span>
                                        </a>
                                    </div>
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-5">
                                        <a href="roster.php?sport=<?php echo $row['sport']; ?>&team=<?php echo urlencode($row['team2_name']); ?>">
                                            ...
                                            <span style="font-weight: bold; text-decoration: none; color: black">
                                                ...
                                                <span style="color: <?php $color2; ?>;">(<?php echo $result2; ?>)</span>
                                            </span>
                                        </a>
                                    </div>
                                </div>
        ...
        <?php
                ...
                echo "No match result available.";
            }
        ?>
