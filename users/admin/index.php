...
<body>
    ...
    <div class="body-wrapper">
      ...
      <header class="app-header">
        <nav class="navbar navbar-expand-lg navbar-dark">
          <!-- Hamburger Icon -->
          <li class="nav-item">
            <button type="button" class="toggle" data-bs-toggle="modal" data-bs-target="#sidebarOptionsModal"
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                  <div class="message-body">
                    <a href="../changepassword.php" target="mainFrame"
  ...
  <!-- Modal -->
  <div class="modal fade" id="sidebarOptionsModal" tabindex="-1" aria-labelledby="sidebarOptionsModalLabel"
    aria-hidden="true">
