...
<div class="table-responsive" style="margin-top: 20px; width: 94%; margin-left: 3%;">
    ...
    <table id="myTable" class="display table" width="100%">
        ...
        <tr>
                ...
                <td>
                    <button class="btn btn-success edit-btn btn-sm" data-id="<?php echo $row['id']; ?>" data-name="<?php echo $row['place']; ?>">Edit</button>

                    <button class="btn btn-danger delete-btn btn-sm" data-id="<?php echo $row['id']; ?>" data-name="<?php echo $row['place']; ?>">Delete</button>
                </td>
        </tr>
        <?php
            }
