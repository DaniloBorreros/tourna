...
<body>
                ...
                <div class="modal-body">
                    <form id="resultForm" method="post" action="crud.php">
                        ...
                        <div class="form-group" hidden>
                            ...
                            <input type="text" class="form-control" id="scheduleDateTime" name="scheduleDateTime"
                                readonly>
                        </div>
                        <div class="form-group" hidden>
                ...
                <form id="rescheduleForm" method="post" action="crud.php">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="datetime-local" class="form-control" id="rescheduleDateTime"
                                name="newScheduleDateTime" required>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        <button type="submit" form="rescheduleForm" class="btn btn-primary"
                            id="rescheduleSubmitBtn">Reschedule</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div id="createScheduleModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                    ...
                    <form id="scheduleForm" method="post" action="crud.php">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" id="otherPlaceInput" class="form-control" name="otherplace"
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    <button type="submit" form="scheduleForm" name="createschedule"
    ...
    <div class="table-responsive" style="margin-top: 20px; width: 94%; margin-left: 3%;">
        <div class="row" style="margin-bottom: 5px;">
            ...
            <button id="createScheduleBtn" class="btn btn-primary btn-sm edit-btn col-md-2"
                style="float: right; right: 20px;">Create schedule</button>
        </div>
